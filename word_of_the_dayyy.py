...
import time
#import pytest
#from  vour_script import fetch_french_words, get_word_of_the_day
...
EMAIL_SENDER = 'shamarbrowne@gmail.com'
EMAIL_RECIPIENT = 'subzero33828@gmail.com'
...
schedule.every().day.at("10:37").do(main, url)
